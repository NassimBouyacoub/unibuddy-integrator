...
function Iframe() {
  ...
  return (
    <div >
    <iframe style={{ height: '98vh',border:"0px" }} data-ub-cookie-consent="necessary" data-ub-lang={langue} id="unibuddy-iframe" scrolling="no" src={slugUni} title="Unibuddy" width="100%">
    </iframe>
